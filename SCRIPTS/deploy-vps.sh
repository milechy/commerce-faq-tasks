...
WITH required(tbl, col) AS (VALUES
  ...
  ('stripe_subscriptions','is_active'), ('stripe_subscriptions','stripe_customer_id'),
  ('stripe_subscriptions','stripe_price_id'), ('stripe_subscriptions','stripe_subscription_id'),
  ('stripe_subscriptions','tenant_id'),
  ('stripe_usage_reports','billed_quantity'), ('stripe_usage_reports','dimension'),
  ('stripe_usage_reports','idempotency_key'),
