...
DEFAULT_REQUIRED='Gate 1 — typecheck + lint + test,security-scan,gitleaks'
...
if [[ "${1:-}" == "--self-test" ]]; then
  ...
  ROLLUP_GREEN='[{"name":"Gate 1 — typecheck + lint + test","conclusion":"SUCCESS"},{"name":"security-scan","conclusion":"SUCCESS"},{"name":"gitleaks","conclusion":"SUCCESS"}]'
  ROLLUP_RED='[{"name":"Gate 1 — typecheck + lint + test","conclusion":"FAILURE"},{"name":"security-scan","conclusion":"SUCCESS"},{"name":"gitleaks","conclusion":"SUCCESS"}]'
