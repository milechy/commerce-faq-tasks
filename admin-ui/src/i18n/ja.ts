const ja = {
  ...
  "account.confirm_password": "新しいパスワード（確認）",
  "account.submit": "パスワードを変更",
  "account.submitting": "変更中...",
  "account.updated": "パスワードを変更しました。",
  "account.err_length": "パスワードは8文字以上で入力してください。",
  "account.err_mismatch": "パスワードが一致しません。",
  "account.err_failed": "パスワードの変更に失敗しました。時間をおいて再度お試しください。",
  "account.hint": "8文字以上。変更後も現在のログインは維持されます。",
  ...
  "billing.ai_cost": "AIコスト（原価・USD概算）",
  "billing.ai_cost_sub": "Groq API利用料",
  "billing.total_amount": "今月の請求見積り",
  "billing.total_amount_sub": "Stripeの実請求単価に基づく概算",
  "billing.amount_unavailable": "算出できません",
  ...
  "billing.csv_header": "日付,リクエスト数,入力トークン,出力トークン,原価概算(USD)",
  ...
  "conversion.effectiveness_awaiting": "まだコンバージョンが記録されていません。接客が成約に繋がると、ここに効果の高いアプローチが表示されます。",
  "conversion.ab_no_experiments": "まだA/Bテストが作成されていません。",
  "conversion.ab_progress": "サンプル収集中（{current} / {required}件）",
  "conversion.ab_ready": "判定に十分なサンプルが集まりました（{current}件）",
