...
const en: Record<TranslationKey, string> = {
  ...
  "tuning.trigger_pattern": "Trigger Pattern (Keywords)",
  "tuning.trigger_pattern_hint": "Enter comma-separated keywords that trigger this rule. Leave blank to apply always.",
  ...
  "tuning.priority_hint": "Higher number means higher priority (0–10)",
