...
const en: Record<TranslationKey, string> = {
  ...
  "account.confirm_password": "New password (confirm)",
  "account.submit": "Change password",
  "account.submitting": "Changing...",
  "account.updated": "Password changed.",
  "account.err_length": "Password must be at least 8 characters.",
  "account.err_mismatch": "Passwords do not match.",
  "account.err_failed": "Failed to change password. Please try again later.",
  "account.hint": "At least 8 characters. You will stay signed in after changing it.",
  ...
  "knowledge.allowed_origins_empty": "⚠️ Unprotected: this Widget currently accepts requests from any domain",
  "knowledge.allowed_origins_empty_desc": "Register at least one domain to reject requests from domains not on this list.",
  ...
  "knowledge.allowed_origins_remove_last_confirm": "This removes the last allowed domain. Once removed, this Widget will accept requests from any domain again.\n\nAre you sure you want to remove it?",
  "knowledge.allowed_origins_first_add_confirm": "Saving this will start rejecting requests from any domain not on this list.\n\nValue to be saved: {origin}\n\nIt must exactly match the URL where the Widget is installed (www vs. no-www, http vs. https, a trailing slash, or a port number will all be rejected).\n\nRegister this value?",
  ...
  "billing.ai_cost": "AI Cost (Base, est. USD)",
  "billing.ai_cost_sub": "Groq API usage fee",
  "billing.total_amount": "Estimated Bill This Month",
  "billing.total_amount_sub": "Based on Stripe's actual unit price",
  "billing.amount_unavailable": "Unavailable",
  ...
  "billing.csv_header": "Date,Requests,Input Tokens,Output Tokens,Est. Cost (USD)",
  ...
  "tuning.approve": "Approve",
  "tuning.reject": "Reject",
  "tuning.approved": "Approved. It will be used in replies from now on.",
  "tuning.rejected": "Rejected. This suggestion will not be used.",
  ...
  "conversion.effectiveness_awaiting": "No conversions recorded yet. Once conversations lead to a sale, the most effective approaches will appear here.",
  "conversion.ab_no_experiments": "No A/B tests created yet.",
  "conversion.ab_progress": "Collecting samples ({current} / {required})",
  "conversion.ab_ready": "Enough samples collected to evaluate ({current})",
