...
| **Standard** | ¥0 | **¥9,800** | ¥98,000 | テキスト1,000 + アバター20 | ¥25/テキスト・¥500/アバター | **既定のみ** |
| Growth | ¥0 | ¥29,800 | ¥298,000 | テキスト3,000 + アバター100 | ¥30/テキスト・¥400/アバター | カスタム可 |
| Enterprise | ¥0 | 個別 | 個別 | 無制限 | ×2.5 | カスタム可 |

**Standard の超過単価は Growth より高く設定してある（アバター ¥500 > ¥400）。** これは意図的で、
Standard でアバターを 40 回超過すると `¥9,800 + 40×¥500 = ¥29,800` とちょうど Growth と同額になり、
かつ Growth なら 100 回使える。**60 回付近で乗り換えが明確に得**になる設計。単価を下げると
この誘導が壊れるので、Standard の超過単価だけを安くしない。
